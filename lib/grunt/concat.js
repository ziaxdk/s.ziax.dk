      ...
      build_js: {
        files: {
          'build/src/js/<%= buildno %>.min.js': [
            ...
            'build/src/bower_components/angular-ui-router/release/angular-ui-router.min.js',
      ...
      build_css: {
        files: {
          'build/src/css/<%= buildno %>.min.css': [
            'build/src/bower_components/animate-css/animate.min.css',
            ...
            'build/src/bower_components/fontawesome/css/font-awesome.min.css'
          ]
        }
      },
      build_dev: {
